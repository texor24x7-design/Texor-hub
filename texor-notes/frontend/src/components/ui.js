/**
 * Texor Notes UI primitives. Mirrors the Texor Account component set so the two
 ...
 * There is no dark cut of the Notes mark yet, and no dark surface to need one.
 */
...
export function LogoIcon({ size = 28 }) {
  return (
    <img src="/brand/notes-icon.svg" alt="Texor Notes" width={size} height={size} className="logo__icon" />
  );
}
