...
/**
 * Chrome for every signed-in Texor Payroll page.
 *
...
export function AppShell({ children }) {
  ...
  if (user === undefined) return <Loading label="Loading Texor Payroll" />;
        ...
        <div className="row row--between" style={{ maxWidth: '62rem', margin: '0 auto' }}>
          <div className="row" style={{ gap: '1rem' }}>
            ...
            <nav className="row" style={{ gap: '0.25rem' }}>
              <a href="/employees" className="btn btn--ghost btn--sm">Employees</a>
              <a href="/pay-runs" className="btn btn--ghost btn--sm">Pay runs</a>
            </nav>
          </div>
