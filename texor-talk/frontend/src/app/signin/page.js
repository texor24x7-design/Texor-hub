...
function SignInContent() {
  ...
  const returnTo = params.get('returnTo') ?? '/channels';
    ...
    <div className="auth-shell">
      <main className="auth-card">
        <div className="auth-card__header stack stack--tight">
          <Logo />
          <h1>Conversations that stay with your team</h1>
          <p>Texor Talk uses your Texor Account, so there is no separate password to remember.</p>
        </div>
        ...
        <div className="auth-card__footer">
          Part of the Texor ecosystem — one account for Texor Talk, Talk and Payroll.
        </div>
      </main>
    </div>
  );
