...
- **Texor Account running** — Finvoice cannot sign anyone in without it

## 1. Get a client secret

Finvoice is registered with Texor Account as an OAuth client. If you ran
...
`finvoice_sid`. In dev, make sure you are reaching the app over `localhost` and
