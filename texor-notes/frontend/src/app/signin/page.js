    ...
    <div className="auth-shell">
      <main className="auth-card">
        <div className="auth-card__header stack stack--tight">
          ...
          <p>Texor Notes uses your Texor Account, so there is no separate password to remember.</p>
        </div>
        ...
        <div className="auth-card__footer">
          Part of the Texor ecosystem — one account for Notes, Talk, Finvoice and Payroll.
        </div>
      </main>
    </div>
  );
