    ...
    <div className="auth-shell">
      <main className="auth-card">
        <div className="auth-card__header stack stack--tight">
          <Logo />
          <h1>Invoicing, without the busywork</h1>
          <p>Finvoice uses your Texor Account, so there is no separate password to remember.</p>
        </div>
        ...
        <div className="auth-card__footer">
          Part of the Texor ecosystem — one account for Finvoice, Talk and Payroll.
        </div>
      </main>
    </div>
  );
